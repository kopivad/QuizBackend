...
public class ApiClients extends TableImpl<ApiClientsRecord> {
    ...
    private static final long serialVersionUID = 786360037;
     ...
     */
    public final TableField<ApiClientsRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
